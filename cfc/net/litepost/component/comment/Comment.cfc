...
Bean Name: Comment
Path to Bean: net.lightblog.component.comment.Comment
Extends: 
...
--->
	...
	--->
	<cffunction name="init" access="public" returntype="net.lightblog.component.comment.Comment" output="false">
