...
Bean Name: Category
Path to Bean: net.lightblog.component.category.Category
Extends: 
...
--->
	...
	--->
	<cffunction name="init" access="public" returntype="net.lightblog.component.category.Category" output="false">
