...
<cfcomponent displayname="User" extends="net.lightblog.component.NullableComponent"
...
--->
	...
	--->
	<cffunction name="init" access="public" returntype="net.lightblog.component.user.User" output="false">
