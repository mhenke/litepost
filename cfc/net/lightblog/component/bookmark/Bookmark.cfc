...
Bean Name: Bookmark
Path to Bean: net.lightblog.component.category.Bookmark
Extends: 
...
--->
	...
	--->
	<cffunction name="init" access="public" returntype="net.lightblog.component.bookmark.Bookmark" output="false">
