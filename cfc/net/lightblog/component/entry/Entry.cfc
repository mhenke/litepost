...
<cfcomponent displayname="Entry" extends="net.lightblog.component.NullableComponent"
...
Bean Name: Entry
Path to Bean: net.lightblog.component.entry
Extends: 
...
--->
	...
	--->
	<cffunction name="init" access="public" returntype="net.lightblog.component.entry.Entry" output="false">
