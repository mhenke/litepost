...
<cfset myFusebox.thisCircuit = "login">
<cfset myFusebox.thisFuseaction = "logout">
<cfset myFusebox.trace("Runtime","&lt;include template=""act_logout.cfm"" circuit=""login""/&gt;") >
<cftry>
<cfoutput><cfinclude template="../home/login/act_logout.cfm"></cfoutput>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse act_logout.cfm in circuit login which does not exist (from fuseaction login.logout).">
...
<cfset variables.title = "Logout Success" >
<cfif isDefined("variables.message")><cfset myFusebox.stack["variables.message"] = variables.message ></cfif>
<cfset variables.message = "You have been logged out successfully." >
