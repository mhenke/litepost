...
<cfset myFusebox.thisCircuit = "entry">
<cfset myFusebox.thisFuseaction = "getRecent">
<cftry>
...
<cfthrow type="fusebox.missingFuse" message="missing Fuse" detail="You tried to include a fuse qry_getEntries.cfm in circuit entry which does not exist (from fuseaction entry.getRecent).">
